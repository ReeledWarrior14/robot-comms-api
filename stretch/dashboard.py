# =============================================================================
#  dashboard.py  —  Stretch Rich terminal dashboard
#
#  Builds the three-panel live layout:
#    Left:   own robot state panel  (Stretch-specific fields)
#    Right:  peers table
#    Bottom: rolling log
# =============================================================================
...
def build_own_panel() -> Panel:
    ...
    tbl.add_row("Battery",      fmt_battery(s.get("battery_percentage"), s.get("battery_voltage")))
    current = s.get("battery_current")
...
def build_peers_table() -> Table:
    ...
    for robot_id in sorted(all_ids):
        ...
        tbl.add_row(
            ...
            fmt_bool(s.get("is_runstopped"), "YES", "No",
                     true_color="red", false_color="green"),
